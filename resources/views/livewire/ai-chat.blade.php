<div x-data="{ 
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300 transform"
        ...
        class="bg-white dark:bg-[#001E2B] w-[350px] sm:w-[400px] h-[600px] max-h-[85vh] rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex flex-col overflow-hidden border border-zinc-200 dark:border-[#1C2D38] mb-4 relative"
        ...
        <div class="flex-1 overflow-y-auto bg-white dark:bg-[#001E2B] custom-scrollbar relative overflow-x-hidden">
            ...
            <div x-show="activeTab === 'home'" x-transition:enter="transition ease-out duration-200"
                ...
                <div
                    ...
                    <div class="p-4 border-b border-zinc-100 dark:border-[#2A3E4A]">
                        <h3 class="font-bold text-sm dark:text-white uppercase tracking-widest text-[10px]">Suggested
                            Articles</h3>
                    </div>
            ...
            <div x-show="activeTab === 'messages'" x-transition:enter="transition ease-out duration-200"
                ...
                <div x-show="isViewingConversation" x-ref="chatContainer"
                    ...
                    @foreach($messages as $msg)
                        <div class="flex {{ $msg['role'] === 'user' ? 'justify-end' : 'justify-start' }} group bounce-in">
                            <div
                    ...
                    @if(count($messages) <= 1)
                        <div wire:loading.remove wire:target="sendMessage" class="pt-4 space-y-3">
                            <p class="text-xs font-bold text-zinc-400 uppercase tracking-wider px-1">Suggested for you</p>
            ...
            <div x-show="activeTab === 'help'" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="space-y-3">
                    <h3 class="text-xs font-bold text-zinc-400 uppercase tracking-widest px-1">Suggested for you</h3>
                    <div
                        class="bg-white dark:bg-[#1C2D38] rounded-2xl shadow-sm border border-zinc-100 dark:border-[#2A3E4A] overflow-hidden">
                        <div class="divide-y divide-zinc-50 dark:divide-[#2A3E4A]">
                ...
                <div class="space-y-3">
                    <h3 class="text-xs font-bold text-zinc-400 uppercase tracking-widest px-1">Browse by Category</h3>
        ...
        <div x-show="activeTab === 'messages' && isViewingConversation"
            ...
            @auth
                ...
                @endif
            @else
                <div class="text-center p-2"><a href="{{ route('login') }}" class="text-xs font-bold text-[#00ED64]">Login
                        to chat</a></div>
            @endauth
        </div>
