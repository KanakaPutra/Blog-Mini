        ...
        <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div x-data="{ 
                ...
                get categoryName() {
                    ...
                    // Since we are in Blade, we can output a JS object or search the DOM.
                    // Simpler approach: Check text content of selected option? 
                    // Better: Pre-render the name if old exists, else default.
            ...
            <!-- Status & Schedule -->
            <div x-data="{ 
                mode: '{{ old('status') == 'draft' ? 'draft' : (old('published_at') ? 'schedule' : 'now') }}',
