<x-app-layout>
    <div class="max-w-6xl mx-auto py-10 px-6 font-sans">
        ...
        <!-- 🔹 FILTER BUTTON (HANYA SUPER ADMIN) -->
        @auth
            @if(auth()->user()->is_admin == 2)
                <div class="mb-8 flex items-center gap-3">
                    ...
                    <a href="{{ route('articles.index') }}"
                       ...
                       {{ request('filter') == 'mine' ? 'bg-gray-200 text-gray-700' : 'bg-blue-600 text-white hover:bg-blue-700' }}">
                       All Artikel
                    </a>
                    ...
                    <a href="{{ route('articles.index', ['filter' => 'mine']) }}"
                       class="px-4 py-2 rounded-md text-sm font-medium 
                       {{ request('filter') == 'mine' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                       Artikel Saya
                    </a>
