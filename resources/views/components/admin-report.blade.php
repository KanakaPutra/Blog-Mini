                ...
                @forelse($reports as $report)
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $report->article->title ?? 'Deleted Article' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-xs text-gray-500">{{ \Illuminate\Support\Str::limit($report->details, 50) }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            @if($report->article)
                                <a href="{{ route('articles.show', $report->article->id) }}" target="_blank" class="text-indigo-600 hover:text-indigo-900">View Article</a>
                            @else
